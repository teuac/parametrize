...
export default function TabelaNcm() {
  ...
  function locateByCodigo() {
    ...
    const idx = rows.findIndex(r => String(r.codigo).toLowerCase() === String(query).toLowerCase());
    const idx2 = rows.findIndex(r => String(r.codigo).toLowerCase().startsWith(String(query).toLowerCase()));
              ...
              <Table>
                ...
                <tbody>
                  {visible.map((r, i) => {
                    ...
                    const isTarget = query && String(r.codigo).toLowerCase().startsWith(String(query).toLowerCase());
