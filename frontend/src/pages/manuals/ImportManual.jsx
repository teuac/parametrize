            ...
            <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
              ...
              <div style={{ color: theme.colors.text, opacity: 0.9 }}>
                ...
                <ul style={{ margin: '8px 0 0 0', paddingLeft: 20 }}>
                  ...
                  <li style={{ marginBottom: 6 }}>Nosso sistema é uma solução automatizada que faz a configuração inicial dos dados, mas a validação, conferência e inserção final no sistema permanecem sob responsabilidade do profissional.</li>
